...
${OBJECTDIR}/page.o: nbproject/Makefile-${CND_CONF}.mk page.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/page.o page.cpp

${OBJECTDIR}/component.o: nbproject/Makefile-${CND_CONF}.mk component.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/component.o component.cpp

${OBJECTDIR}/matrix.o: nbproject/Makefile-${CND_CONF}.mk matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/matrix.o matrix.cpp

${OBJECTDIR}/transform.o: nbproject/Makefile-${CND_CONF}.mk transform.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/transform.o transform.cpp

${OBJECTDIR}/main.o: nbproject/Makefile-${CND_CONF}.mk main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/config.o: nbproject/Makefile-${CND_CONF}.mk config.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/config.o config.cpp

${OBJECTDIR}/android.o: nbproject/Makefile-${CND_CONF}.mk android.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/android.o android.cpp

${OBJECTDIR}/test.o: nbproject/Makefile-${CND_CONF}.mk test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/test.o test.cpp

${OBJECTDIR}/documentLayout.o: nbproject/Makefile-${CND_CONF}.mk documentLayout.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/opencv/ -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/documentLayout.o documentLayout.cpp
