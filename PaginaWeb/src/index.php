...
<p class="Titulo" id="insilico" name="insilico"> Investigaci&oacute;n con funci&oacute;n social</p>
  <p class="Titulo" id="insilico2" name="insilico2">INS&Iacute;LICO</p>
	  ...
	  la IA trata de «desarrollar sistemas que piensen y actúen racionalmente» V. Julián, V. Botti. “…podemos pensar que la IA, en su conjunto, trata realmente de construir precisamente dichas entidades autónomas e inteligentes (los agentes inteligentes).” V. Julián, V. Botti.
			</p>
			<br />
			<br />
			<br />
...
<p id="informacion">
Trabajamos en este momento en el desarrollo de una aplicación, usando distintas técnicas de IA
</p>
</div>
<div id="content32">
<img src="css/Picture2.jpg" alt="imagen2" width="131" height="137" />
<p id="informacion">Buscamos solución al problema de los “Policías Corruptos”.
</p>
</div>
