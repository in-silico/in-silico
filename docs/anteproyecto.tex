...
\clearpage
	...
	\subsection{Muestra}
	Se tomará una muestra de $N$ textos con un tamaño y tipo de fuente específicas. Se tomarán
	fotos con el celular de dichos textos para realizar la medición de variables.
	
	\subsection{Variables}
	Las variables a tener en cuenta son el porcentaje de caracteres reconocidos, y los recursos
	computacionales utilizados (Cantidad de memoria y tiempo de CPU) para realizar dicho
	reconocimiento.
