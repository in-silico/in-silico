...
%\contraportada
	...
	Es posible desarrollar un sistema de reconocimiento óptico de caracteres, cuyo radio de eficacia
	sobre su eficiencia sea superior a el de los sistemas OCR de licenciamiento	libre disponibles
	en la actualidad, al procesar una misma imagen tomada con una cámara de un celular inteligente en
	el mismo sistema de cómputo. %Y de un doc con que características
