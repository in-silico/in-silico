...
\clearpage
    ...
    llama binarización al proceso de cambiar el valor de un pixel dentro de un formato de imagen estandar a 
    1 o 0, dependiendo generalmente de un valor límite llamado threshold.
