...
\clearpage
    ...
    impreso, en los que los elementos que lo component como párrafos o imágenes se pueden inscribir
    dentro de rectángulos de área mínima, de modo que los lados de modo que la pendiente de dos lados
    de estos es igual para todos los rectángulos.
    ...
    llama binarización a de	cambiar el valor de un pixel dentro de un formato de imagen estandar a 
    1 o 0, dependiendo generalmente de un valor límite generalmente llamado threshold.
	...
	Es posible desarrollar un sistema de reconocimiento óptico de caracteres, optimizado de manera que su radio de eficacia sobre su eficiencia sea superior a los sistemas disponibles en la actualidad, de código abierto. Cuando procesan el mismo documento sobre un sistema de computo similar.
En donde su eficacia se define como el radio de caracteres reconocidos correctamente dividido entre el  numero total de caracteres.
Y la eficiencia es un indicador compuesto de la cantidad de memoria utilizada y tiempo total de ejecución.
	...
	\item Cantidad de letras en el documento impreso.
	\item Tiempo de reconocimiento de una pagina vacía.
