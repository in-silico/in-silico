...
%\contraportada
	...
	Desarrollar un sistema prototipo de reconocimiento óptico de dígitos numéricos, usando para el reconocimiento una
	distribución normal multivariable, en teorema de Bayes y un vector de características invariantes.
	...
	invariantes a la rotación, translación y escalamiento.
