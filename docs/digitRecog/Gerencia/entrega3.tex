...
\portada
	...
	\begin{itemize}
	      ...
	      \item $A4$ : En este proyecto no se va a considerar la publicidad, ya que la publicidad viene implícita en la comisión, pues los proveedores publicitan el producto para ganar la comisión.
	...
	\begin{itemize}
		...
		\item {\bf Secretaria (oficios varios)} Una persona con titulo de bachiller o estudios de secretaria.

	\end{itemize}	
	
	Los salarios para cada uno serian:

	Gerente: \$5.000.000 mensuales
	Investigador en desarrollo: \$2.500.000 mensuales
	Investigador en inteligencia artificial: \$2.500.000 mensuales
	Desarrolladores: \$1.500.000 mensuales
	Tecnico: \$1.000.000 mensuales
	Secretaria: \$1.000.000 mensuales

	Se contratarian: 1 gerente, 1 investigador en desarrollo, 1 investigador en inteligencia artificial, 2 desarrolladores, 1 tecnico y 1 secretaria.
	...
	CDT (360 dias): 4.49\%
	TES ( 10 años): 8.16\%
	Inflación proyectada DANE (2011): 2 - 4\%
	Inflación acumulado (Enero - Marzo 2011): 1.79\%
	Inflación real proyectada (nosotros) (2011): 6 - 8\%
	Tasa de credito para inversión en Colombia: 16.7\%
