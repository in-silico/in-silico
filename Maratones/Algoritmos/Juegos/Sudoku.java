...
public class Sudoku 
{
	...
	public static void limpiarZona(int[][] zona, int[] actuales, int[] grupos, int[] tamGrupos, int[][] sudoku, int[] visitados)
	{
		while(true)
		{
			int iActual = 0;
	...
	public static void limpiar(int[][] sudoku, int[][] grupos, int[][] tamGrupos)
	{
		for(int i = 0; i < tS2 * 3; i++)
			limpiarZona(zonas[i], actuales, grupos[i], tamGrupos[i], sudoku, visitados);
	}
