...
%\contraportada
	...
	\item Provar diferentes subconjuntos de características con métodos de aprendizaje no supervisado para determinar cuales 
	características son	mejores y cuales redundantes.
	\item Provar diferentes algoritmos de aprendizaje supervisado con la base de datos de características previamente obtenidas. 
	...
	\begin{itemize}
		...
		\item Selección de algortimo de aprendizaje a usar en el OCR
		\item Diseño e implementación del reconocimiénto óptico de caracteres
...
saulo.torres@utp.edu.co
	...
	\begin{itemize}
		\item Un artículo en la selección de un conjunto de características apropiadas para reconocer caracteres usando algortimos de aprendizaje
		no supervisado.
		\item Un artículo en selección de un algoritmo de aprendizaje con sus respectivos parametros, que sea apropiado para el problema
