...
Finalmente se analizan los resultados obtenidos por los diferentes algoritmos implementados para el reconocimiento de dígitos, y se muestra la flexibilidad y escalabilidad del sistema, al incluir reconocimiento de los caracteres del alfabeto latino en mayúsculas. Se analisan los resultados del reconocimiento optico de caracteres y se plantean proyectos futuros para agregar la funcionalidad requerida por las personas invidentes.
