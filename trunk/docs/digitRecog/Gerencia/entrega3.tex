...
\portada
	...
	\subsection{Objetivo}
	El objetivo de este estudio de mercado es determinar la cantidad de usuarios que puede llegar a tener el sistema de asistencia a las personas invidentes. Esto con la finalidad de determinar la viabilidad del proyecto, ...
	...
	\subsubsection{Situación esperada}
	\begin{sidewaystable}[h]
		\caption{Análisis histórico, situación vigente y proyectada en los 5 submercados}
		\begin{tabular}{ | p{2cm} | p{6cm} | p{6cm} | p{6cm} | }
		\hline
		Mercado & Situación anterior & Situación actual & Situación proyectada \\
		\hline					
		Proveedores & 
