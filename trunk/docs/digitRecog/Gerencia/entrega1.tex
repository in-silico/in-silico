...
\portada
	...
	\begin{sidewaystable}[h]	
		\caption{Relación del proyecto con el plan de la universidad}
		\begin{tabular}{ | p{7cm} | p{7cm} | p{7cm} | }
		\hline
		Misión & Visión & Formulación de proyectos y estrategia financiera\\
		\hline					
		La relación en la misión esta en que ambos fueron concebidos para mejorar la calidad de la eduación de nuestra región. & La relación en la visión esta en que ambos, tanto nuestro proyecto como el plan de desarrollo de la universidad, tienen el lograr un impacto social como una de sus metas. & Estos proyectos ya fueron aprobados, sin embargo podemos apreciar que el tiempo en el que se van a desarrollar es similar y que tiene en comun con nuestro proyecto el objetivo de generar un impacto positivo en la sociedad. \\
		\hline
		\end{tabular}
		\label{universidad}
	\end{sidewaystable}
